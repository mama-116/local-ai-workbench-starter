...
初期値、1イベントの変化量上限、時間減衰は実装前の固定シナリオ試験で決める未決事項である。キャラクターPolicyは許可範囲内で感受性、回復速度、表現を変えられるが、共通Policyより優先せず、秘密漏えい、虐待称賛、報復、羞恥、課金・長時間利用・秘密開示の誘導を許可しない。
